public class Main {
    ...
    public static String nameCandidate(String race, int id) {

        if (race.equals("president")) {
            return presidentc[id];
        }
        if (race.equals("vp")) {
            return vpc[id];
        }
        if (race.equals("secretary")) {
            return secretaryc[id];
        }
        if (race.equals("treasurer")) {
            return treasurerc[id];
        }
        else {
            return "error";
        }
    ...
    public static int voteCounter(String[] toBeCounted) {
        for (int j=0;j<(toBeCounted.length-1);j++) {
            switch (toBeCounted[j]) {
                case "0":
                    voting[0]++;
                    break;
                case "1":
        ...
        if ((voting[0]>voting[1]) && (voting[0]>voting[2]) && (voting[0]>voting[3]) && (voting[0]>voting[4])) {
            return 0;
        }
        if ((voting[1]>voting[0]) && (voting[1]>voting[2]) && (voting[1]>voting[3]) && (voting[1]>voting[4])) {
            return 1;
        }
        if ((voting[2]>voting[0]) && (voting[2]>voting[1]) && (voting[2]>voting[3]) && (voting[2]>voting[4])) {
            return 2;
        }
        if ((voting[3]>voting[0]) && (voting[3]>voting[1]) && (voting[3]>voting[2]) && (voting[3]>voting[4])) {
            return 3;
        }
        else if ((voting[4]>voting[0]) && (voting[4]>voting[1]) && (voting[4]>voting[2]) && (voting[3]>voting[3])) {
            return 4;
        }
