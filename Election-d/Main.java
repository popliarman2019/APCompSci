public class Main {
	...
	// write your code here
        ...
        System.out.println("\nYour new Vice President: " + nameCandidate(vp,voteCounter(vp)));
        System.out.println("\nYour new Secretary: " + nameCandidate(secretary,voteCounter(secretary)));
        System.out.println("\nYour new Treasurer: " + nameCandidate(treasurer,voteCounter(treasurer)));
    }
    ...
    public static int voteCounter(String[] toBeCounted) {
        ...
        if ((v1>v0) && (v1>v2) && (v1>v3) && (v1>v4)) {
            return 1;
        }
        if ((v2>v0) && (v2>v1) && (v2>v3) && (v2>v4)) {
            return 2;
        }
        if ((v3>v0) && (v3>v1) && (v3>v2) && (v3>v4)) {
            return 3;
        }
        if ((v4>v0) && (v4>v1) && (v4>v2) && (v4>v3)) {
            return 4;
        }
    }

    public static String nameCandidate(String race, int id) {
        String[] presidentc = {"Mordy Golding", "Shira Gotshalk", "Stephanie Evans", "Ray Villalobos"};
        String[] vpc = {"Dona Sarkar", "Tyler Ahn", "Joe Camp", "Brandon LeBlanc"};
        String[] secretaryc = {"Jason Howard", "Nikki Rubino", "Peggy Fisher", "Neil Edde"};
        String[] treasurerc = {"David Gassner", "Sharon Bennett", "Walt Ritscher", "Heather Hurley"};
        if (race.equals("president")) {
            return presidentc[id-1];
        }
        if (race.equals("vp")) {
            return vpc[id-1];
        }
        if (race.equals("secretary")) {
            return secretaryc[id-1];
        }
        if (race.equals("treasurer")) {
            return treasurerc[id-1];
        }
    }
